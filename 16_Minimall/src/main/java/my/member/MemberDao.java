...
public class MemberDao {
	...
	public int insertMember(MemberBean mdto) throws Exception {
	...
	public MemberBean getMemberByNameAndSsn(String name, String ssn1, String ssn2) throws Exception {
		Connection conn = getConnection();
		MemberBean mdto = null;
	...
	public MemberBean getMemberDTO(ResultSet rs) throws SQLException {
	...
	public MemberBean getPasswordByIdAndNameAndSsn(String id, String name, String ssn1, String ssn2) throws Exception {
		Connection conn = getConnection();
		MemberBean mdto = null;
